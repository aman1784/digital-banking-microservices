...
@Configuration
@OpenAPIDefinition(
        info = @Info(title = "Account Service API", version = "v1", description = "Endpoints for managing bank accounts"),
...
public class OpenApiConfig {
    // No additional code needed; the annotations handle the configuration.
}